...
/*
BY - Sagar Kumar Nayak
this is a class to create a bottom nav bar with a cut at center using a bazier curve.
a fab icon can be out there
*/
...
//        mPaint.setColor(ContextCompat.getColor(getContext(), android.R.color.white));
        mPaint.setColor(Color.parseColor("#AAECF3F8"));
